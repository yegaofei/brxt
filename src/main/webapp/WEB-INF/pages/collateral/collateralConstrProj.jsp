...
<div class="col-sm-10">
    ...
    <div class="col-sm-3 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <form:input path="constrProj.type" id="owner"  cssClass="form-control"/>
    ...
    <div class="col-sm-3 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <form:input path="constrProj.projectSize" id="projectSize"  cssClass="form-control"/>
    ...
    <div class="col-sm-3 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <form:input path="constrProj.floor" id="floor"  cssClass="form-control"/>
    ...
    <div class="col-sm-3 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <form:input path="constrProj.rightsType" id="rightsType"  cssClass="form-control"/>
    ...
    <div class="col-sm-3 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <form:input path="constrProj.yearsLimit" id="yearsLimit"  cssClass="form-control"/>
    ...
    <div class="col-sm-3 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <form:input path="constrProj.price" id="price"  cssClass="form-control"/>
