...
<div class="col-sm-10">
    ...
    <form:form commandName="projectInfo" method="post" action="financialStatements" id="projectInfoForm" cssClass="well">
    <form:hidden path="id"/>
	...
	<div class="row">
		...
		<display:table name="projectInfo.counterparties" id="counterparty" class="table table-condensed table-striped table-hover">  			
  			<display:column titleKey="projectInfo.counterparty.name">
  				<c:url value="/financialStatements" var="counterpartyUrl">
		...
		<display:table name="projectInfo.guarantors" id="guarantor" class="table table-condensed table-striped table-hover">  			
  			<display:column titleKey="projectInfo.guarantor.name" href="/financialStatements">   
  				<c:url value="/financialStatements" var="guarantorUrl">
